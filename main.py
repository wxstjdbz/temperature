...
# =========================================
st.markdown(
    '<div class="main-title">🌡️ 기온 예측기 ☀️</div>',
    unsafe_allow_html=True
)

st.markdown(
    '<div class="subtitle">서울의 과거 기온 데이터를 이용해서 미래의 기온을 예측해 봐요! 🐰✨</div>',
    unsafe_allow_html=True
)
...
# 전체 기간 회귀
# =========================================
full_slope, full_intercept, full_corr = (
...
# 최근 20년 회귀
# =========================================
recent_slope, recent_intercept, recent_corr = (
...
# =========================================
st.success(
    f"🌱 회귀 직선은 **{number_of_years}개 연도**의 자료로 만들었어요! "
...
with col1:
    st.markdown(
        f'<div class="info-card">📚 사용한 연도<br><b>{number_of_years}개</b></div>',
        unsafe_allow_html=True
    )

with col2:
    st.markdown(
        f'<div class="info-card">🐣 시작 연도<br><b>{start_year}년</b></div>',
        unsafe_allow_html=True
    )

with col3:
    st.markdown(
        f'<div class="info-card">🐰 끝 연도<br><b>{end_year}년</b></div>',
        unsafe_allow_html=True
    )
...
with slope_col1:
    ...
    st.markdown(
        f'<div class="slope-card">'
        f'<div class="slope-title">🌍 전체 기간</div>'
        f'<div class="slope-value">{full_text}</div>'
        f'<div class="slope-unit">100년에 변화하는 평균기온</div>'
        f'<div class="period">{start_year}년 ~ {end_year}년</div>'
        f'</div>',
        unsafe_allow_html=True
    )
...
with slope_col2:
    ...
    st.markdown(
        f'<div class="slope-card">'
        f'<div class="slope-title">🕐 최근 20년</div>'
        f'<div class="slope-value">{recent_text}</div>'
        f'<div class="slope-unit">100년에 변화하는 평균기온</div>'
        f'<div class="period">{recent_start_year}년 ~ {end_year}년</div>'
        f'</div>',
        unsafe_allow_html=True
    )
...
st.markdown(
    f'<div class="temp-box">'
    f'🌡️ {selected_year}년 예상 평균기온<br>'
...
st.caption(
    "💡 예상기온은 전체 기간의 회귀 직선을 이용해서 계산했어요."
)
...
- 남은 자료로 연도별 평균기온 계산
- 전체 기간의 연평균기온으로 선형회귀
- 마지막 사용 연도를 기준으로 최근 20년을 추출
- 최근 20년의 연평균기온으로 별도의 선형회귀
- 회귀선의 기울기 × 100을 계산하여
  '100년에 몇 °C 변하는가'로 표시
- 연도 슬라이더 범위: 1900년 ~ 2100년
    """)
